...
## 文件事件处理器的构成
![](/images/20181118222228409_1225431651.png)
...
### 一次完整的客户端和服务器链接过程
![](/images/20181118232748468_1461583627.png)
...
![](/images/20181119120319275_2055226855.png)
...
- redis中的事件事件任务都有serverCron函数负责执行，他的任务包括
    ...
    - 集群模式则对集群定期进行同步和连接测试
### 主循环处理文件事件和时间事件的伪代码
![](/images/20181119222754573_532442591.png)
![](/images/20181119222816587_198269888.png)
- 获取最接近的时间事件的还有多久到达
...
- 事件事件一般会比设定的时间晚一点
![](/images/20181119223619038_1574871119.png)
